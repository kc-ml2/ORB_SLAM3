...
public:
    ...
    Sophus::SE3f TrackMonocular_2(const cv::Mat &im, const double &timestamp, int ni, const vector<TextFrame> textFrameArray, const std::vector<ProminentSignMap> ProminentSignMapList, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
